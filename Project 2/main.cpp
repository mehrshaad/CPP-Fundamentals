#include <iostream>
#include<iomanip>   //khorooji matrix (setw , setprecision)
#include<conio.h>   //baraye getch
#include<stdlib.h>   //baraye system cls
using namespace std;
...
void read_matrix_double_2(double d[][100], int x, char L) {      //baraye khandan matrix ba addad aashariee
	for (int i = 0; i < x; i++) {
		for (int j = 0; j < x; j++) {
			cout << L << "(" << i + 1 << "," << j + 1 << ") :";
			cin >> d[i][j];
